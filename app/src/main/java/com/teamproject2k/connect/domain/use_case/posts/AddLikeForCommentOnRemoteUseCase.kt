...
class AddLikeForCommentOnRemoteUseCase @Inject constructor(private val repository: IPostRepository) {
    /**
     * Adds a like for a comment on the remote repository.
     * This function is invoked as an operator on an instance of a class or function object.
     * @param commentId The ID of the comment for which the like should be added.
     ...
     *         - ResponseState.Success if the like for the comment was successfully added.
